...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-navy-900 via-navy-800 to-navy-900 relative overflow-hidden py-12">
      ...
      <div className="w-full max-w-md mx-4 relative z-10">
        <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
          ...
          <div className="bg-navy-800 px-8 py-6 text-center">
            ...
            <p className="text-navy-300 text-sm mt-1">Join {SITE_SHORT_NAME} today</p>
          </div>
          ...
          <div className="p-8">
            ...
            <div className="mt-6 pt-5 border-t border-navy-100 text-center space-y-3">
              <p className="text-sm text-navy-500">
                ...
                <Link href="/login" className="text-river-500 hover:text-river-600 font-medium">
                  Sign in
                </Link>
              </p>
              <Link
